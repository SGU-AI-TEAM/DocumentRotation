...
rec = DocRecognizer(model_path="inference/saved_model/")
image = cv2.cvtColor(cv2.imread("labelme_annotation/JPEGImages/1 (11).jpg"), cv2.COLOR_BGR2RGB)
rec.predict_one(image)